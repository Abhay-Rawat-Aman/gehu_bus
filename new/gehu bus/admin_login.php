          ...
          <div class="row g-0">
            ...
            <div class="col-xl-6">
              <div class="card-body p-md-5 text-black" style="font-weight:800">
                <h3 class="mb-5 text-uppercase" style="font-weight:900; font-size:28px; text-align:center">Admin Login Form</h3>

                <div class="form-outline mb-4">
				<label class="form-label" for="form3Example8">Admin Id</label>
                  <input type="text" id="form3Example8" class="form-control form-control-lg" name="id" required />
                </div>
...
<?php
	if(isset($_POST['login']))
	{
		$id=$_POST['id'];
		$pass=$_POST['pass'];
		$q="select * from admin where username='$id' and pass='$pass'; ";
		...
		$_SESSION['admin_name']=strtoupper($var['name']);
