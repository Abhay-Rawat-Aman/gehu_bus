  <footer id="footer" class="footer">
      ...
      <div class="row gy-4">
        ...
        <div class="col-lg-2 col-6 footer-links">
          ...
          <ul>
            ...
            <li><a href="conductor_login.php">Conductor</a></li>
            <li><a href="coordinator_login.php">Coordinator</a></li>
        ...
        <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
          ...
          <p>
            ...
            <strong>Email:</strong> aman141920@gmail.com<br>
          </p>
    ...
    <div class="container mt-4">
      ...
      <div class="credits">
        ...
        Designed by <a href="https://bootstrapmade.com/">Abhay Rawat ans his team</a>
      </div>
    </div>
