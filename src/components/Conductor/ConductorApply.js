          ...
          <div className="row g-0">
            <div className="col-xl-6 d-none d-xl-block">
              ...
              <img src="assets/img/gehu_signup2.jpeg"
               ...
               style={{borderTopLeftRadius:'.25rem',borderBottomLeftRadius:'.25rem', height:'762px', width:'100%'}}/>
              }
            </div>
            <div className="col-xl-6">
              <div className="card-body p-md-5 text-black" style={{fontWeight:'800'}}>
                <h3 className="mb-5 text-uppercase" style={{fontWeight:'900', fontSize:'28px', textAlign:'center'}}>Conductor Apply</h3>
                ...
                <div className="row">
                  <div className="col-md-12 mb-4">
                    <div className="form-outline">
						<label className="form-label" htmlFor="form3Example1m">User Name</label>
						<input type="number" id="cuser" name="cuser" className="form-control form-control-lg" required />
                    </div>
                  </div>
                </div>
                ...
                <div className="row">
                  ...
                  <div className="col-md-6 mb-4">
                    <div className="form-outline">
						...
						<input type="password" id="cpass" name="cpass" autoComplete='off' className="form-control form-control-lg" required />
                    </div>
                  </div>
